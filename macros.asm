...
Print_NumM Macro buuferDiv, entero
...
; Suamr dos numeros de 3 dígitos 
SumaM Macro num1, num2, reusltado

                        xor    ax,ax                                                                                                                                                                                                                                                 ;limpiar ax
                        mov    ax, num1                                                                                                                                                                                                                                            ;poner en ax el valor de num2
                        add    resultado, ax                                                                                                                                                                                                                                             ;sumar num1 a suma
                        mov    ax, num2                                                                                                                                                                                                                                             ;poner en ax el valor de num1
                        add    resultado, ax                                                                                                                                                                                                                                             ;sumar num2 a suma
...
ImprimirResultadoSRM Macro u,d,c,uMillar,resultado
                        ...
                        mov    uMillar,al    
                                                                                                                                                                                                                                                                 ;guardar miles en uMillar                                                                                                                                                                                                                                             ;reservar espacio en la pila para uMillar
                        ImprimirNum uMillar                                                                                                                                                                                                                                           ;llamar a PrintNum para imprimir el resultado                                                                                                                                                                                                                                              ;reservar espacio en la pila para c
