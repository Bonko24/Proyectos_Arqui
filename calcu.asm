...
include macros.asm
extrn InicializarDS:Far, ClearScreenP:Far, WhereXYP:Far, GotoXYP:Far, PrintCharColorP:Far, PrintCharP:Far, PrintNum:Far, PrintString:Far, ReadKey:Far,WaitKeyP:Far,GetCommanderLine:Far, Print_Num:Far, Print_Dec:far, ConversionNum:Far, ArmarP:Far, SumaP:Far, ImprimirResultadoSR:Far
